      ...
      <main>
        ...
        <section id="section2" className={styles.section2}>
          <div className="hidden grid-cols-3 gap-20 p-[24px] lg:grid lg:p-[60px]">
            <div className="hidden self-start bg-stone-50 py-[16px] px-[8px] lg:grid">
              <ol>
                <a
                  href="#header1"
                  onClick={() => {
            ...
            <div className="col-span-2">
              ...
              <ol className="notoBody02 mt-[16px]">
                <li>
                  ...
                  give us consent throughout the duration of your personal data
                  with us (The Right to withdraw).
                </li>
                <li>
                ...
                <li>
                  7. The data subject shall have the right to object, on grounds
              ...
              <ul className="notoBody02 mt-[16px]">
                <li>
                  ...
                  providing a direct marketing to you, we will be able to do so
                  only when you give us explicit consent and we have already
                  informed you the purpose of your personal data’s use on direct
                  marketing. However, you can withdraw your consent on direct
                  marketing with us at any time through our opt-out system.
                </li>
                <li>
                  ...
                  products and services to the public, we will not process your
                  data for direct marketing unless you give us an explicit
                  consent to use your personal data for direct marketing and we
                  have already informed you the purpose of your personal data’s
                  use on direct marketing. However, you can withdraw your
                  consent on direct marketing with us at any time through our
                  opt-out system.
                </li>
              </ul>
              ...
              <p className="notoBody02 mt-[16px]">
                ...
                to help us provide better, faster and safer services and support
                your privacy when you use our services through our website. We
                use Cookies in the following cases:
              </p>
              <ul className="notoBody02 mt-[16px]">
                <li>
                  ...
                  disabling this cookie, you can set up your device by watching
                  helping methods on your browser or device.
                </li>
                <li>
                  ...
                  allow those third parties process your personal data, you can
                  choose to disable this type of cookies on our website.
                </li>
              </ul>
              ...
              <p className="notoBody02 mt-[16px]">
                We, SEASIA Leadavation Center Company Limited strictly abide by
                our Privacy Policy for Employees. When we use your personal data
                to provide service to you, your personal data is protected under
              ...
              <p className="notoBody02 mt-[16px]">
                ...
                disclosure your personal data as well as your rights to your
                personal data as the data subject. We reaffirm that we comply
                with the law to protect your personal data. Click here for more
                details.
              </p>
              ...
              <p className="notoBody02 mt-[16px]">
                This Privacy Policy is used for our service and our website use
                only. If you click on a link to another website (although via
                our website). You will have to study and comply with the privacy
                policy displayed on that website separate from ours.
              </p>
              <h3 className="dinProH3 mt-[32px]" id="header13">
                Change of privacy policy
              </h3>
              <p className="notoBody02 mt-[16px]">
                We will review our privacy policy regularly. In case of changing
                privacy policy, it will be announced on our website or other
                platforms.
              </p>
